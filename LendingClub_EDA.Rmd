...
Here we can easily see possible correlations using the DataExplorer package, and the plot_correlation function.

```{r}
clean <- loans %>%
  select(c(loan_amnt, int_rate, installment, grade, total_bal_il))
